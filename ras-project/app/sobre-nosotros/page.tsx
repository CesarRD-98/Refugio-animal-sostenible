        ...
        >
          <div className="grid gap-10 lg:grid-cols-[1.2fr,0.9fr] items-start">
            ...
            <div className="relative">
              <div className="absolute -inset-x-6 -inset-y-4 rounded-3xl bg-gradient-to-b from-white via-stone-50 to-emerald-50/60 pointer-events-none hidden sm:block" />
              <div className="relative rounded-3xl border border-stone-200 bg-white/90 px-4 py-5 sm:px-7 sm:py-7 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-3xl border border-stone-200 bg-white p-5 sm:p-6 shadow-sm">
                ...
                <p className="text-sm text-stone-700">
                  ...
                  y promoviendo la{" "}
                  <strong>adopción responsable</strong> en armonía con la
                  comunidad.
                </p>
              </div>
