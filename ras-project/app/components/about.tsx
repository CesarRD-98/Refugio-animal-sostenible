        ...
        >
            <div className="grid gap-8 lg:grid-cols-[1.1fr,1fr] items-center ">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                    <div className="rounded-md border border-orange-100 bg-white p-4 shadow-sm hover:shadow-md hover:-translate-y-1 transition">
                    ...
                    <div className="rounded-md border border-orange-100 bg-white p-4 shadow-sm hover:shadow-md hover:-translate-y-1 transition sm:col-span-2">
                        <div className="flex items-center gap-2 mb-2">
                ...
                {/* Columna derecha: texto breve + CTA */}
                <div className="space-y-5">
                    <p className="text-sm sm:text-base text-stone-700">
                        ...
                        misión, visión y valores en la página dedicada de sobre nosotros.
                    </p>
